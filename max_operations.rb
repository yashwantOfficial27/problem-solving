def max_operations(nums, k)
    ...
    nums.each_with_index do |num1, idx1|
        nums.each_with_index do |nums2, idx2|
            if idx1 != idx2 
                if nums[idx1]+nums[idx2] == k
                    # puts "idx1 = #{idx1} and idx2 = #{idx2}"
                    # puts nums
                    count += 1
                    nums.delete_at(idx1)
                    nums.delete_at(idx2-1)
                end
            end
        end
    end
